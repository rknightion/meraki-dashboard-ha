...
## [0.40.0](https://github.com/rknightion/meraki-dashboard-ha/compare/v0.39.1...v0.40.0) (2026-09-26)
...
* **deps:** update dependency meraki to v4.5.0 ([#396](https://github.com/rknightion/meraki-dashboard-ha/issues/396)) ([c5d38bb](https://github.com/rknightion/meraki-dashboard-ha/commit/c5d38bbb0007650688e0da8972c4bc07033b519c))
...
* adopt canonical routing and bounded root rescue ([0398a67](https://github.com/rknightion/meraki-dashboard-ha/commit/0398a67e23082a596e649a347d1fb0090b97bafc))
...
* **agents:** custom_components/meraki_dashboard to AGENTS.md standard ([baf9420](https://github.com/rknightion/meraki-dashboard-ha/commit/baf9420973ca22fc158579e56a378c7da7258ab6))
* **agents:** meraki-dashboard-ha root to AGENTS.md standard ([d9f195b](https://github.com/rknightion/meraki-dashboard-ha/commit/d9f195ba958edb43f43cbf468dbb8abc2a12d7dd))
* **agents:** remove custom_components/meraki_dashboard/hubs agent file ([c2877d8](https://github.com/rknightion/meraki-dashboard-ha/commit/c2877d887f6748b6fe843c49f13643a8bf6713f0))
* **agents:** review fix custom_components/meraki_dashboard ([694825d](https://github.com/rknightion/meraki-dashboard-ha/commit/694825d06e3e01d8bf532444c896f1ddc11133ca))
* **agents:** review fix meraki-dashboard-ha root ([c680e3b](https://github.com/rknightion/meraki-dashboard-ha/commit/c680e3b7177331cb95e9d41a88c053eaaa1a4f3f))
* **agents:** tests to AGENTS.md standard ([e31bbf2](https://github.com/rknightion/meraki-dashboard-ha/commit/e31bbf28871f85765894840d7674d562f6512a60))
* align recovery contracts and compaction evidence ([300ea2b](https://github.com/rknightion/meraki-dashboard-ha/commit/300ea2b5ba41fc2f9cbe8f105ae80eed4f309a3b))
...
* **backlog:** sync fan-out protocol — CodeRabbit review gate ([65aacef](https://github.com/rknightion/meraki-dashboard-ha/commit/65aacef251fe8bc09f40c1c39dc2be01ecdcaa83))
* **backlog:** sync fan-out protocol — success criteria vs write authority ([f884e6e](https://github.com/rknightion/meraki-dashboard-ha/commit/f884e6e1484b1e04886f2389f0c575df76ca9335))
...
* publish canonical agent documents ([fe42941](https://github.com/rknightion/meraki-dashboard-ha/commit/fe42941d0ea571a13b70d2ccaf76ca1843bcf915))
* publish canonical agent documents ([148350d](https://github.com/rknightion/meraki-dashboard-ha/commit/148350d47067c6b5c620af91a3da3a1eb1beae22))
* publish canonical agent documents ([8f74866](https://github.com/rknightion/meraki-dashboard-ha/commit/8f7486647eb883dbb5014328ef983d56b5dcba65))
* publish canonical agent documents ([cb070f2](https://github.com/rknightion/meraki-dashboard-ha/commit/cb070f227b2e638249f8fd27de56a5f6b7952014))
* publish canonical agent documents ([051f347](https://github.com/rknightion/meraki-dashboard-ha/commit/051f34738c02b6bf31485823d024dd90ec03a46f))
* publish canonical agent documents ([43e234a](https://github.com/rknightion/meraki-dashboard-ha/commit/43e234a483f89640b4deeeceb76e7bf4883bf293))
* publish canonical agent documents ([9811d37](https://github.com/rknightion/meraki-dashboard-ha/commit/9811d3776a69cfe7430a9ef837b7f4ab95f5761e))
* publish canonical agent documents ([c46606c](https://github.com/rknightion/meraki-dashboard-ha/commit/c46606c3c30c0baeac5bfb49ef4aec3b10d73ac4))
* publish canonical agent documents ([0190164](https://github.com/rknightion/meraki-dashboard-ha/commit/019016402250d98b96995ae4f0a78d51d91c8074))
* publish canonical agent documents ([d3bb697](https://github.com/rknightion/meraki-dashboard-ha/commit/d3bb697c89012505cd1b7c968adea5ee9c2edffd))
* publish canonical agent documents ([1ba9414](https://github.com/rknightion/meraki-dashboard-ha/commit/1ba94148adea5dd54d1d7b439fa498b1cc9262e1))
* publish canonical agent documents ([efd2b66](https://github.com/rknightion/meraki-dashboard-ha/commit/efd2b6650f27512b036bf8b02ae12af4ab33b331))
* publish canonical agent documents ([ebaba7e](https://github.com/rknightion/meraki-dashboard-ha/commit/ebaba7ec55e049bc2a223b9dd5b64898e60e8839))
* publish canonical agent documents ([897ad97](https://github.com/rknightion/meraki-dashboard-ha/commit/897ad9787787067859d0c8425c29281f4a0cdd21))
* publish canonical agent documents ([d05d3ee](https://github.com/rknightion/meraki-dashboard-ha/commit/d05d3ee0f174bc168c233c6a8d55c1f841cedbbd))
* publish canonical agent documents ([1edc188](https://github.com/rknightion/meraki-dashboard-ha/commit/1edc188bc070c3bfff1f61197a2bb2c2670609c3))
* publish canonical agent documents ([35c7aff](https://github.com/rknightion/meraki-dashboard-ha/commit/35c7aff6d14acc85ce0695cceaefffa6920aa73b))
* publish public Backlog workspace ([5cf15ad](https://github.com/rknightion/meraki-dashboard-ha/commit/5cf15adabe2337f14ae99da07cda95b31c4f729f))
...
* re-import the fan-out protocol at c1e6cb0 ([50a1ab9](https://github.com/rknightion/meraki-dashboard-ha/commit/50a1ab9962d7b2ce06b6b7d77595d15ac579606c))
...
* sync agent-docs, a wave's launch message is a file not a chat block ([3cf3fd9](https://github.com/rknightion/meraki-dashboard-ha/commit/3cf3fd9eeabe6df72d984d37c53ca4520d064a7b))
* sync approved fan-out scheduling and route verification ([4beafb1](https://github.com/rknightion/meraki-dashboard-ha/commit/4beafb119f604aa2ae4957346b0fa30caeb276b0))
* sync Astra routing and default wave reports to files ([1cb1ef7](https://github.com/rknightion/meraki-dashboard-ha/commit/1cb1ef77c3a4a5fb80fd00db5856143cd920faca))
* sync authorised Astra root judgement ([7af66d8](https://github.com/rknightion/meraki-dashboard-ha/commit/7af66d85c5f8c59943f6c38586d416f101899dad))
* sync authorised Astra root judgement ([cbeea2d](https://github.com/rknightion/meraki-dashboard-ha/commit/cbeea2d4fe692e463efbeb37cc15ed892d8bb6cc))
* sync cost-aware fan-out routing and prompt guidance ([9eacf62](https://github.com/rknightion/meraki-dashboard-ha/commit/9eacf6287cea3d7f7da127d02a14968fafc81c37))
* sync fan-out async decision-only guidance ([7cf12a8](https://github.com/rknightion/meraki-dashboard-ha/commit/7cf12a8b45280a28778e32cc3387953cf5af5e04))
* sync fan-out protocol from agent-docs ad7abd2 ([22fb8ce](https://github.com/rknightion/meraki-dashboard-ha/commit/22fb8ce8ee671a32ea3cb4136200459ed3362068))
* sync fan-out protocol, delegated root authority for unattended runs ([a233a18](https://github.com/rknightion/meraki-dashboard-ha/commit/a233a187e41c537a2d5297941fa54ac03bffd3b8))
* sync fan-out protocol, explicit add does not bound the commit ([67dae99](https://github.com/rknightion/meraki-dashboard-ha/commit/67dae99e7f5eb9b57bb8ca160124e430c22cb5b8))
* sync fixed Astra low orchestration and rescue routing ([3e24455](https://github.com/rknightion/meraki-dashboard-ha/commit/3e244554903726ba21b39cab8543c74d14bfb35d))
* sync nineteen-worker Codex fan-out guidance ([f844a2b](https://github.com/rknightion/meraki-dashboard-ha/commit/f844a2b1c1766bd9f2a7c62b773642caaa4e3d3c))
* sync optional Astra fan-out routing and run contracts ([3a106c7](https://github.com/rknightion/meraki-dashboard-ha/commit/3a106c70463e000d529d1abdea2b41d09387b54a))
* sync polling and integration contracts ([529fda1](https://github.com/rknightion/meraki-dashboard-ha/commit/529fda1b5ec5deb0d3a590b1219f449702e56e22))
* sync root async question policy ([3ea827a](https://github.com/rknightion/meraki-dashboard-ha/commit/3ea827a6218a71dffc508f26fab4402722a7e41c))
* sync same-session fan-out recovery contract ([441b95e](https://github.com/rknightion/meraki-dashboard-ha/commit/441b95e2b0ef0619b6c0bd4cf08d67c0cf5f1c11))
* sync wave orchestration and existing-root contracts ([f16e341](https://github.com/rknightion/meraki-dashboard-ha/commit/f16e3418b93ea11ad1e18eb237c5e07eddb32303))
* sync wave reliability and worktree contracts ([718c962](https://github.com/rknightion/meraki-dashboard-ha/commit/718c9628ff4f1e27a8b3d41e603f32521a0aeb4e))
* sync wave-root stage authority and lab-Mac GUI gate ([5ed47aa](https://github.com/rknightion/meraki-dashboard-ha/commit/5ed47aaa1959c310a0ba3afa4da0424b09bb09ea))
...
* align CodeRabbit review configuration ([e4cb479](https://github.com/rknightion/meraki-dashboard-ha/commit/e4cb479af1dec503bac0c49c30250e979b112ff2))
* **backlog:** add MDH-0007 — migrate the repo task surface to just ([0634839](https://github.com/rknightion/meraki-dashboard-ha/commit/0634839332904ba610edb6fd209a566799c38472))
* **backlog:** close the just migration task ([7292c42](https://github.com/rknightion/meraki-dashboard-ha/commit/7292c42974af651524c03820f42f9194ce6b55d2))
* **backlog:** ratify ci as the sanctioned superset of check ([ec4cf7a](https://github.com/rknightion/meraki-dashboard-ha/commit/ec4cf7a71f7f4b00eb454d6d3107b4c73ecabd5b))
* **backlog:** wire the fleet migration ordering into this task ([088c2fb](https://github.com/rknightion/meraki-dashboard-ha/commit/088c2fb4ab3b30935b5f23b4b030633c296628f5))
* **build:** migrate the task surface to just ([7b233f9](https://github.com/rknightion/meraki-dashboard-ha/commit/7b233f9397ee316ea88bcaf17b22733d5eba799d))
...
* **deps:** lock file maintenance ([#369](https://github.com/rknightion/meraki-dashboard-ha/issues/369)) ([9075ef6](https://github.com/rknightion/meraki-dashboard-ha/commit/9075ef60c81be7accab51e9d17d37ff6b522918b))
* **deps:** lock file maintenance ([#388](https://github.com/rknightion/meraki-dashboard-ha/issues/388)) ([1ec9312](https://github.com/rknightion/meraki-dashboard-ha/commit/1ec93129c5e1fa87ad93f6d3a518bcf428cb77ce))
...
* **deps:** update anthropics/claude-code-action action to v1.0.200 ([#367](https://github.com/rknightion/meraki-dashboard-ha/issues/367)) ([cddccb7](https://github.com/rknightion/meraki-dashboard-ha/commit/cddccb7c680ee5a7e684ba714c21103d7b432be6))
* **deps:** update anthropics/claude-code-action action to v1.0.201 ([#368](https://github.com/rknightion/meraki-dashboard-ha/issues/368)) ([80af919](https://github.com/rknightion/meraki-dashboard-ha/commit/80af919f4d9f7d04939f921565ca164046978223))
* **deps:** update anthropics/claude-code-action action to v1.0.202 ([#370](https://github.com/rknightion/meraki-dashboard-ha/issues/370)) ([be8d68a](https://github.com/rknightion/meraki-dashboard-ha/commit/be8d68aa4b24e533240bf2ac1dc59bf3ffd75ffa))
* **deps:** update anthropics/claude-code-action action to v1.0.204 ([#371](https://github.com/rknightion/meraki-dashboard-ha/issues/371)) ([30f0a55](https://github.com/rknightion/meraki-dashboard-ha/commit/30f0a55c33e530a1730fd1e77f5162d7ef33b8de))
* **deps:** update anthropics/claude-code-action action to v1.0.205 ([#372](https://github.com/rknightion/meraki-dashboard-ha/issues/372)) ([714bdfe](https://github.com/rknightion/meraki-dashboard-ha/commit/714bdfe84018b6d763d04d2a8d64826155809efc))
* **deps:** update anthropics/claude-code-action action to v1.0.206 ([#373](https://github.com/rknightion/meraki-dashboard-ha/issues/373)) ([7ac82ff](https://github.com/rknightion/meraki-dashboard-ha/commit/7ac82ff8ec95506ab9cd09b05ba92d3d5f869fbf))
* **deps:** update anthropics/claude-code-action action to v1.0.207 ([#374](https://github.com/rknightion/meraki-dashboard-ha/issues/374)) ([1ce0b60](https://github.com/rknightion/meraki-dashboard-ha/commit/1ce0b606f89dc92a20997b262f118681e3004872))
* **deps:** update anthropics/claude-code-action action to v1.0.208 ([#375](https://github.com/rknightion/meraki-dashboard-ha/issues/375)) ([37d27a2](https://github.com/rknightion/meraki-dashboard-ha/commit/37d27a27a1b0419264af9ffb849ef7b463918eb5))
* **deps:** update anthropics/claude-code-action action to v1.0.209 ([#376](https://github.com/rknightion/meraki-dashboard-ha/issues/376)) ([33f2968](https://github.com/rknightion/meraki-dashboard-ha/commit/33f29685485bc0f05de4307c7c063a50ce8637f1))
* **deps:** update anthropics/claude-code-action action to v1.0.210 ([#377](https://github.com/rknightion/meraki-dashboard-ha/issues/377)) ([3660dd7](https://github.com/rknightion/meraki-dashboard-ha/commit/3660dd7ef4fac73a5d84cfe8eda6c8d3d6b8bef3))
* **deps:** update anthropics/claude-code-action action to v1.0.211 ([#390](https://github.com/rknightion/meraki-dashboard-ha/issues/390)) ([19c79d5](https://github.com/rknightion/meraki-dashboard-ha/commit/19c79d51ad40fd9c87c4aca13440b602d435030a))
* **deps:** update anthropics/claude-code-action action to v1.0.212 ([#391](https://github.com/rknightion/meraki-dashboard-ha/issues/391)) ([a332b98](https://github.com/rknightion/meraki-dashboard-ha/commit/a332b984913431891e302394a803cc11c1199f5a))
* **deps:** update anthropics/claude-code-action action to v1.0.213 ([#392](https://github.com/rknightion/meraki-dashboard-ha/issues/392)) ([911ac20](https://github.com/rknightion/meraki-dashboard-ha/commit/911ac20366c5b8744d3a4a07bb26a3e2c3b1fa8f))
* **deps:** update anthropics/claude-code-action action to v1.0.216 ([#394](https://github.com/rknightion/meraki-dashboard-ha/issues/394)) ([607279f](https://github.com/rknightion/meraki-dashboard-ha/commit/607279fd04c7000f62051b6e0db202b6270768d6))
* **deps:** update anthropics/claude-code-action action to v1.0.217 ([#397](https://github.com/rknightion/meraki-dashboard-ha/issues/397)) ([7c6babc](https://github.com/rknightion/meraki-dashboard-ha/commit/7c6babc411d5feffc3d7d568fb19bfa3831a4e8e))
* **deps:** update anthropics/claude-code-action action to v1.0.218 ([#401](https://github.com/rknightion/meraki-dashboard-ha/issues/401)) ([4595384](https://github.com/rknightion/meraki-dashboard-ha/commit/45953841f794580b2d6884d7c6b807e57e43311a))
* **deps:** update anthropics/claude-code-action action to v1.0.219 ([#402](https://github.com/rknightion/meraki-dashboard-ha/issues/402)) ([408337c](https://github.com/rknightion/meraki-dashboard-ha/commit/408337cd3004a4bdccdd1029b592874002b896f5))
* **deps:** update anthropics/claude-code-action action to v1.0.220 ([#403](https://github.com/rknightion/meraki-dashboard-ha/issues/403)) ([d1d6aa6](https://github.com/rknightion/meraki-dashboard-ha/commit/d1d6aa6488433e5e845018f6537bf180e0ade15a))
* **deps:** update anthropics/claude-code-action action to v1.0.221 ([#405](https://github.com/rknightion/meraki-dashboard-ha/issues/405)) ([512e8ef](https://github.com/rknightion/meraki-dashboard-ha/commit/512e8efc820876cf4a59bf7ccc5878006bb4d8eb))
* **deps:** update anthropics/claude-code-action action to v1.0.222 ([#406](https://github.com/rknightion/meraki-dashboard-ha/issues/406)) ([2bc4af9](https://github.com/rknightion/meraki-dashboard-ha/commit/2bc4af93dd3a231b0ba558f3ce3d429b75c9baf8))
* **deps:** update anthropics/claude-code-action action to v1.0.223 ([#407](https://github.com/rknightion/meraki-dashboard-ha/issues/407)) ([a060ec8](https://github.com/rknightion/meraki-dashboard-ha/commit/a060ec82c4dd98aadc6e58d7026981ca39e6aa3d))
* **deps:** update anthropics/claude-code-action action to v1.0.224 ([#409](https://github.com/rknightion/meraki-dashboard-ha/issues/409)) ([f5ff503](https://github.com/rknightion/meraki-dashboard-ha/commit/f5ff5034486923587970cb7261b66e069bcffea1))
* **deps:** update anthropics/claude-code-action action to v1.0.225 ([#410](https://github.com/rknightion/meraki-dashboard-ha/issues/410)) ([0338675](https://github.com/rknightion/meraki-dashboard-ha/commit/0338675955366677320977c6c7b7dde72056cfde))
* **deps:** update anthropics/claude-code-action action to v1.0.226 ([#412](https://github.com/rknightion/meraki-dashboard-ha/issues/412)) ([2061deb](https://github.com/rknightion/meraki-dashboard-ha/commit/2061debd325df813e603fc1e1b7f0a2f237d4cb2))
* **deps:** update anthropics/claude-code-action action to v1.0.227 ([#413](https://github.com/rknightion/meraki-dashboard-ha/issues/413)) ([59b23e9](https://github.com/rknightion/meraki-dashboard-ha/commit/59b23e9fadac140f7b76a930124f1d10264407d0))
* **deps:** update anthropics/claude-code-action action to v1.0.228 ([#415](https://github.com/rknightion/meraki-dashboard-ha/issues/415)) ([95f214b](https://github.com/rknightion/meraki-dashboard-ha/commit/95f214b7f748394ba598d7ae111260cbe15f4afe))
* **deps:** update anthropics/claude-code-action action to v1.0.229 ([#416](https://github.com/rknightion/meraki-dashboard-ha/issues/416)) ([7205c40](https://github.com/rknightion/meraki-dashboard-ha/commit/7205c403fae8fd5c5efeb84a5fe78ebe25c4502c))
* **deps:** update anthropics/claude-code-action action to v1.0.230 ([#418](https://github.com/rknightion/meraki-dashboard-ha/issues/418)) ([52bd0fe](https://github.com/rknightion/meraki-dashboard-ha/commit/52bd0fefa17deaa41b681085ef24f459cecb7311))
* **deps:** update anthropics/claude-code-action action to v1.0.231 ([#419](https://github.com/rknightion/meraki-dashboard-ha/issues/419)) ([c4b7bbe](https://github.com/rknightion/meraki-dashboard-ha/commit/c4b7bbeb79f520910652a8da32970ef8baf12d02))
* **deps:** update anthropics/claude-code-action action to v1.0.232 ([#422](https://github.com/rknightion/meraki-dashboard-ha/issues/422)) ([6b7eec3](https://github.com/rknightion/meraki-dashboard-ha/commit/6b7eec33c5d0d096ed746009b866b9a64db80b5f))
* **deps:** update anthropics/claude-code-action action to v1.0.233 ([#424](https://github.com/rknightion/meraki-dashboard-ha/issues/424)) ([c128a33](https://github.com/rknightion/meraki-dashboard-ha/commit/c128a337e7c9e451d2f41c7a172131748f2ba399))
* **deps:** update anthropics/claude-code-action action to v1.0.234 ([#425](https://github.com/rknightion/meraki-dashboard-ha/issues/425)) ([f0cb0b4](https://github.com/rknightion/meraki-dashboard-ha/commit/f0cb0b47f978e33062696b5f716508a0e1ef48a1))
* **deps:** update anthropics/claude-code-action action to v1.0.235 ([#426](https://github.com/rknightion/meraki-dashboard-ha/issues/426)) ([b9a9a44](https://github.com/rknightion/meraki-dashboard-ha/commit/b9a9a44b68c96e4dacc38b983bafde3686364996))
...
* **deps:** update astral-sh/setup-uv action to v10.1.0 ([#404](https://github.com/rknightion/meraki-dashboard-ha/issues/404)) ([29b5521](https://github.com/rknightion/meraki-dashboard-ha/commit/29b552161df27ffb6f472bd73d311b396a81775c))
* **deps:** update astral-sh/setup-uv action to v10.2.0 ([#421](https://github.com/rknightion/meraki-dashboard-ha/issues/421)) ([372fc9e](https://github.com/rknightion/meraki-dashboard-ha/commit/372fc9e0f8d8f22f75157456ca9f662c4db4b702))
...
* **deps:** update codecov/codecov-action action to v7.1.0 ([#411](https://github.com/rknightion/meraki-dashboard-ha/issues/411)) ([0c0f6f6](https://github.com/rknightion/meraki-dashboard-ha/commit/0c0f6f6700e17bb4f84f79d3d8e3f7b5c5651d47))
* **deps:** update codecov/codecov-action action to v7.1.1 ([#414](https://github.com/rknightion/meraki-dashboard-ha/issues/414)) ([970413f](https://github.com/rknightion/meraki-dashboard-ha/commit/970413ffdadc7b57cd88c4421d92ba1ae2b187ca))
* **deps:** update rknightion/.github action to v1.10.0 ([#381](https://github.com/rknightion/meraki-dashboard-ha/issues/381)) ([ae91952](https://github.com/rknightion/meraki-dashboard-ha/commit/ae919524ad9946895c170f0a32b5417e52a83514))
* **deps:** update rknightion/.github action to v1.10.1 ([#382](https://github.com/rknightion/meraki-dashboard-ha/issues/382)) ([e06b475](https://github.com/rknightion/meraki-dashboard-ha/commit/e06b475bab31dc93bc66d2017737416644bc161c))
* **deps:** update rknightion/.github action to v1.13.0 ([#383](https://github.com/rknightion/meraki-dashboard-ha/issues/383)) ([9d79551](https://github.com/rknightion/meraki-dashboard-ha/commit/9d7955147a43656e6d2d16fe52e1dec5a9ef2f4a))
* **deps:** update rknightion/.github action to v1.15.0 ([#384](https://github.com/rknightion/meraki-dashboard-ha/issues/384)) ([044ffab](https://github.com/rknightion/meraki-dashboard-ha/commit/044ffaba00d49839586cb9d417f0ed5da46c2879))
* **deps:** update rknightion/.github action to v1.15.1 ([#385](https://github.com/rknightion/meraki-dashboard-ha/issues/385)) ([8fb63b3](https://github.com/rknightion/meraki-dashboard-ha/commit/8fb63b3a436aba7c74144f5e1abf3b0412510001))
* **deps:** update rknightion/.github action to v1.17.0 ([#386](https://github.com/rknightion/meraki-dashboard-ha/issues/386)) ([0ef02b2](https://github.com/rknightion/meraki-dashboard-ha/commit/0ef02b20bcd38072551c42100b4cbfcd43ae32f6))
* **deps:** update rknightion/.github action to v1.17.1 ([#387](https://github.com/rknightion/meraki-dashboard-ha/issues/387)) ([04f8134](https://github.com/rknightion/meraki-dashboard-ha/commit/04f8134f27f68bb89533bb73a26602c6bf99f1fa))
* **deps:** update rknightion/.github action to v1.18.0 ([#393](https://github.com/rknightion/meraki-dashboard-ha/issues/393)) ([1f93b8d](https://github.com/rknightion/meraki-dashboard-ha/commit/1f93b8d5d4301bcc079c4a1275f6d11641929298))
* **deps:** update rknightion/.github action to v1.20.0 ([#395](https://github.com/rknightion/meraki-dashboard-ha/issues/395)) ([31b420d](https://github.com/rknightion/meraki-dashboard-ha/commit/31b420d16bd85a5cbdd0befa182b88b1c4d6e54d))
* **deps:** update rknightion/.github action to v1.20.1 ([#398](https://github.com/rknightion/meraki-dashboard-ha/issues/398)) ([bbea09b](https://github.com/rknightion/meraki-dashboard-ha/commit/bbea09bff4851f0f6e21d230f4230e181449a591))
* **deps:** update rknightion/.github action to v1.21.0 ([#399](https://github.com/rknightion/meraki-dashboard-ha/issues/399)) ([1c91085](https://github.com/rknightion/meraki-dashboard-ha/commit/1c910854c4c3eedd267f413f1bbd273171abaa62))
* **deps:** update rknightion/.github action to v1.21.1 ([#408](https://github.com/rknightion/meraki-dashboard-ha/issues/408)) ([7fab814](https://github.com/rknightion/meraki-dashboard-ha/commit/7fab814493275777c59c9331b2ff0fbbd02f4f17))
* **deps:** update rknightion/.github action to v1.22.0 ([#417](https://github.com/rknightion/meraki-dashboard-ha/issues/417)) ([2adef22](https://github.com/rknightion/meraki-dashboard-ha/commit/2adef22d1fa892c63d110c588c7943908ec23426))
* **deps:** update rknightion/.github action to v1.23.0 ([#420](https://github.com/rknightion/meraki-dashboard-ha/issues/420)) ([1794fa4](https://github.com/rknightion/meraki-dashboard-ha/commit/1794fa46b740d37215ec45028fc9bc212d531c82))
* **deps:** update rknightion/.github action to v1.24.0 ([#423](https://github.com/rknightion/meraki-dashboard-ha/issues/423)) ([bcf03b4](https://github.com/rknightion/meraki-dashboard-ha/commit/bcf03b45868a51c58a4559b70cce766f4b672462))
* **deps:** update rknightion/.github action to v1.9.10 ([#380](https://github.com/rknightion/meraki-dashboard-ha/issues/380)) ([41c081a](https://github.com/rknightion/meraki-dashboard-ha/commit/41c081ad8762715fc28febbbc9a5450034500106))
* **deps:** update rknightion/.github action to v1.9.8 ([#378](https://github.com/rknightion/meraki-dashboard-ha/issues/378)) ([93a65a2](https://github.com/rknightion/meraki-dashboard-ha/commit/93a65a28961c091561919bd317b5ac4166f83794))
* **deps:** update rknightion/.github action to v1.9.9 ([#379](https://github.com/rknightion/meraki-dashboard-ha/issues/379)) ([7cffa5f](https://github.com/rknightion/meraki-dashboard-ha/commit/7cffa5fc3d55ba9f50cd51ace1cd2e8a1f6e5585))
...
* **deps:** update step-security/harden-runner action to v2.21.1 ([#389](https://github.com/rknightion/meraki-dashboard-ha/issues/389)) ([33dbace](https://github.com/rknightion/meraki-dashboard-ha/commit/33dbaced29df0eba2eabc9e90d61845dc25c5ee2))
...
* ignore machine-local codex/ ([15f33f4](https://github.com/rknightion/meraki-dashboard-ha/commit/15f33f4109f061ed088e3e9e0d64875b02810cdb))
...
* **reviews:** declare linked repositories for cross-repo review context ([3b836db](https://github.com/rknightion/meraki-dashboard-ha/commit/3b836db81317876a83704250f518b50ed793dcff))
...
* This major version supports only Meraki MT environmental sensors. MR, MS, and MV devices are no longer supported; their entities are removed automatically on upgrade with a repair notice. The HA domain (meraki_dashboard) is unchanged, so no manual reconfiguration is required.

### Features

* **ci:** add Meraki API + SDK drift early-warning; un-vendor SDK to upstream v3 ([1ad9b00](https://github.com/rknightion/meraki-dashboard-ha/commit/1ad9b00ed8778134b8491e9855f38fab5c85d68f))
* **docs:** align docs site with m7kni.io brand + server-side SEO/LLM metadata ([e2d160c](https://github.com/rknightion/meraki-dashboard-ha/commit/e2d160cb9f2d53ac7009ea1ea96800e65af65624)), closes [#293](https://github.com/rknightion/meraki-dashboard-ha/issues/293)
* MT-only major version — strip MR/MS/MV, overhaul MT API calling ([a820159](https://github.com/rknightion/meraki-dashboard-ha/commit/a82015989133432a42cc4a354d2eb8efad5b605e)), closes [#295](https://github.com/rknightion/meraki-dashboard-ha/issues/295) [#296](https://github.com/rknightion/meraki-dashboard-ha/issues/296) [#297](https://github.com/rknightion/meraki-dashboard-ha/issues/297) [#298](https://github.com/rknightion/meraki-dashboard-ha/issues/298) [#299](https://github.com/rknightion/meraki-dashboard-ha/issues/299) [#300](https://github.com/rknightion/meraki-dashboard-ha/issues/300) [#301](https://github.com/rknightion/meraki-dashboard-ha/issues/301)
* **mt:** add NO2, O3, and PM10 air-quality sensors ([b29c33e](https://github.com/rknightion/meraki-dashboard-ha/commit/b29c33e2463b7b7543badf2786b0859a430ab155)), closes [#302](https://github.com/rknightion/meraki-dashboard-ha/issues/302)


### Bug Fixes

* **deps:** update dependency meraki to v3.3.0 ([#279](https://github.com/rknightion/meraki-dashboard-ha/issues/279)) ([1f2e696](https://github.com/rknightion/meraki-dashboard-ha/commit/1f2e696ba60ca79f6ab3ebfb004d5a1cd9e59528))
* **docs:** remove glightbox slide_effect option (rejected by zensical 0.0.44) ([283babb](https://github.com/rknightion/meraki-dashboard-ha/commit/283babb2e1a5b4a9985695c1cff353b5673acdc0))


### Documentation

* **geo:** content-shape pass for LLM/search retrievability ([8d54cc1](https://github.com/rknightion/meraki-dashboard-ha/commit/8d54cc193b17f18434cccc8f92545f65779b29dd))


### Miscellaneous Chores

* automerge Renovate vulnerability-fix PRs ([8bb46fb](https://github.com/rknightion/meraki-dashboard-ha/commit/8bb46fb070ec382a5074fee79bbc70a19450c543))
* **deps:** lock file maintenance ([#267](https://github.com/rknightion/meraki-dashboard-ha/issues/267)) ([62a1731](https://github.com/rknightion/meraki-dashboard-ha/commit/62a17315bd13b493909d3000326d4ba64f0c41db))
* **deps:** lock file maintenance ([#270](https://github.com/rknightion/meraki-dashboard-ha/issues/270)) ([e0caa6c](https://github.com/rknightion/meraki-dashboard-ha/commit/e0caa6c0ec16487a30bf5d46f02abf3a2d6c04fd))
* **deps:** lock file maintenance ([#274](https://github.com/rknightion/meraki-dashboard-ha/issues/274)) ([ca97736](https://github.com/rknightion/meraki-dashboard-ha/commit/ca97736e2b05a5e8220b0192e7b32d8e22513aaa))
* **deps:** lock file maintenance ([#275](https://github.com/rknightion/meraki-dashboard-ha/issues/275)) ([228788f](https://github.com/rknightion/meraki-dashboard-ha/commit/228788f6699ac6137e21dc44b0fee3a2c307c4bb))
* **deps:** lock file maintenance ([#276](https://github.com/rknightion/meraki-dashboard-ha/issues/276)) ([9bb3fb2](https://github.com/rknightion/meraki-dashboard-ha/commit/9bb3fb26ffdceccc0cb3f516f4503f726db34bd1))
* **deps:** lock file maintenance ([#278](https://github.com/rknightion/meraki-dashboard-ha/issues/278)) ([078b373](https://github.com/rknightion/meraki-dashboard-ha/commit/078b37331b54b6e75df3e563460924a00b846b5e))
* **deps:** lock file maintenance ([#280](https://github.com/rknightion/meraki-dashboard-ha/issues/280)) ([689eeeb](https://github.com/rknightion/meraki-dashboard-ha/commit/689eeeb08fe958a280c07e96a0711b7a1253825d))
* **deps:** lock file maintenance ([#281](https://github.com/rknightion/meraki-dashboard-ha/issues/281)) ([f76fde2](https://github.com/rknightion/meraki-dashboard-ha/commit/f76fde2312b7d62973549ee3814af029d8a258ad))
* **deps:** lock file maintenance ([#289](https://github.com/rknightion/meraki-dashboard-ha/issues/289)) ([d7810bf](https://github.com/rknightion/meraki-dashboard-ha/commit/d7810bf3addfb2d441628da81d43587a6da13977))
* **deps:** pin rknightion/.github action to 8629ccb ([#287](https://github.com/rknightion/meraki-dashboard-ha/issues/287)) ([7d45860](https://github.com/rknightion/meraki-dashboard-ha/commit/7d458602a1b8b24a29a4c771901a6b5f7922cb56))
* **deps:** update anthropics/claude-code-action action to v1.0.159 ([#284](https://github.com/rknightion/meraki-dashboard-ha/issues/284)) ([9a49850](https://github.com/rknightion/meraki-dashboard-ha/commit/9a498501039de7ebe8a0751e205263f8cabb6768))
* **deps:** update anthropics/claude-code-action action to v1.0.159 ([#286](https://github.com/rknightion/meraki-dashboard-ha/issues/286)) ([a8c282d](https://github.com/rknightion/meraki-dashboard-ha/commit/a8c282d48d6ceae0fe8fbfd43bda48ff1b305af9))
* **deps:** update anthropics/claude-code-action action to v1.0.160 ([#290](https://github.com/rknightion/meraki-dashboard-ha/issues/290)) ([562f02b](https://github.com/rknightion/meraki-dashboard-ha/commit/562f02bd028dacc4410d0813b95f652ca109d1bd))
* **deps:** update anthropics/claude-code-action action to v1.0.161 ([#291](https://github.com/rknightion/meraki-dashboard-ha/issues/291)) ([c01774d](https://github.com/rknightion/meraki-dashboard-ha/commit/c01774da6b0daddf6e14945399144402f472c43e))
* **deps:** update anthropics/claude-code-action action to v1.0.162 ([#292](https://github.com/rknightion/meraki-dashboard-ha/issues/292)) ([0de3966](https://github.com/rknightion/meraki-dashboard-ha/commit/0de3966ac0b678722275721ae68b31a57594cccf))
* **deps:** update anthropics/claude-code-action action to v1.0.163 ([#294](https://github.com/rknightion/meraki-dashboard-ha/issues/294)) ([199e2f7](https://github.com/rknightion/meraki-dashboard-ha/commit/199e2f770f3a45a97ea3ae0a12113423d9ee09cc))
* **deps:** update anthropics/claude-code-action digest to 6e2bd52 ([#271](https://github.com/rknightion/meraki-dashboard-ha/issues/271)) ([7738554](https://github.com/rknightion/meraki-dashboard-ha/commit/7738554e8c4e6d4275aeebb525905605c4e9fe2a))
* **deps:** update anthropics/claude-code-action digest to 88c168b ([#268](https://github.com/rknightion/meraki-dashboard-ha/issues/268)) ([77070be](https://github.com/rknightion/meraki-dashboard-ha/commit/77070be5d72b6eb08e60e16cc16d3eea85feac2f))
* **deps:** update anthropics/claude-code-action digest to e7b588b ([#265](https://github.com/rknightion/meraki-dashboard-ha/issues/265)) ([2e6d6d7](https://github.com/rknightion/meraki-dashboard-ha/commit/2e6d6d723a9629f98cab0cb775822b6947cb54c0))
* **deps:** update astral-sh/setup-uv action to v8 ([#266](https://github.com/rknightion/meraki-dashboard-ha/issues/266)) ([e257b32](https://github.com/rknightion/meraki-dashboard-ha/commit/e257b32ba5eb94f5e4e6d8b13a776b520acaefe9))
* **deps:** update codecov/codecov-action action to v6 ([#261](https://github.com/rknightion/meraki-dashboard-ha/issues/261)) ([b1fbace](https://github.com/rknightion/meraki-dashboard-ha/commit/b1fbace1a04a1f9dfb644132d9c8710894752e8e))
* **deps:** update github actions ([#269](https://github.com/rknightion/meraki-dashboard-ha/issues/269)) ([53569f4](https://github.com/rknightion/meraki-dashboard-ha/commit/53569f440812dcf7e9fc2ab2c47ccb24f8ffe5b5))
* **deps:** update github actions ([#272](https://github.com/rknightion/meraki-dashboard-ha/issues/272)) ([ff88650](https://github.com/rknightion/meraki-dashboard-ha/commit/ff88650fc7ae4216ec0e31fc927b2c3ca5792174))
* **deps:** update github actions ([#273](https://github.com/rknightion/meraki-dashboard-ha/issues/273)) ([70a0536](https://github.com/rknightion/meraki-dashboard-ha/commit/70a05360de0a6f31e5f19d136168afedf8f698c5))
* **deps:** update github actions ([#282](https://github.com/rknightion/meraki-dashboard-ha/issues/282)) ([3f98a79](https://github.com/rknightion/meraki-dashboard-ha/commit/3f98a796ab83e24eb34b418249e378da6401fc80))
* **deps:** update github actions ([#283](https://github.com/rknightion/meraki-dashboard-ha/issues/283)) ([0e9de46](https://github.com/rknightion/meraki-dashboard-ha/commit/0e9de4638bb383970564114a34e41305445ca948))
* **deps:** update googleapis/release-please-action action to v5 ([#277](https://github.com/rknightion/meraki-dashboard-ha/issues/277)) ([5fb277f](https://github.com/rknightion/meraki-dashboard-ha/commit/5fb277ff6a683b9f038f439d1816ac36834dd0b1))
* **deps:** update rknightion/.github digest to 17626c1 ([#288](https://github.com/rknightion/meraki-dashboard-ha/issues/288)) ([2866180](https://github.com/rknightion/meraki-dashboard-ha/commit/28661807f782050118b5fcf2942b3f6d089fc73f))
* **renovate:** slim to repo-specific overrides ([98279b7](https://github.com/rknightion/meraki-dashboard-ha/commit/98279b7ae704f37e1b92897ae9e09a97c66e0390))
* stop tracking accidentally-committed Codacy summary artifact ([73e3ccf](https://github.com/rknightion/meraki-dashboard-ha/commit/73e3ccf11cbf7f126878c67d7e0a3d32f881d6d4))
* trigger CI re-run (reconcile zizmor alerts on current reusable) ([6ea345a](https://github.com/rknightion/meraki-dashboard-ha/commit/6ea345ae4bbea7946e9bb322c0c58fb1c735fa65))


### Build System

* require Python 3.14 to match Home Assistant ([0f89f1b](https://github.com/rknightion/meraki-dashboard-ha/commit/0f89f1b66b66bf86a1e1173e409ccb84544cebb1))
...
## [0.37.1](https://github.com/rknightion/meraki-dashboard-ha/compare/v0.37.0...v0.37.1) (2026-03-27)
