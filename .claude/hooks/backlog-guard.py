...
than documented and hoped about (see AGENTS.md "Backlog tracker — non-negotiable rules"):
    ...
    if tool == "Bash":
        ...
        if m:
            ...
            deny(
                ...
                f"misunderstanding — see AGENTS.md \"Backlog tracker — non-negotiable rules\"."
            )
        sys.exit(0)
