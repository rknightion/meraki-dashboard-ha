...
from custom_components.meraki_dashboard.diagnostics import async_get_config_entry_diagnostics
...
class TestDiagnostics:
    ...
    async def test_async_get_config_entry_diagnostics_full_data(self, hass: HomeAssistant, mock_config_entry):
        ...
        mock_coordinator.last_update_success = datetime.fromisoformat("2024-01-01T12:00:00+00:00")
        ...
        with patch('custom_components.meraki_dashboard.diagnostics.async_get_device_registry') as mock_dr:
        ...
        assert result["organization"]["networks_count"] == 0  # mock_org_hub.networks = [] by default
        ...
        assert coord_info["last_update_success"] is True  # coordinator.last_update_success is not None
    ...
    async def test_async_get_config_entry_diagnostics_no_data(self, hass: HomeAssistant, mock_config_entry):
    ...
    async def test_async_get_config_entry_diagnostics_partial_data(self, hass: HomeAssistant, mock_config_entry):
    ...
    async def test_async_get_config_entry_diagnostics_no_org_hub(self, hass: HomeAssistant, mock_config_entry):
        ...
        with pytest.MonkeyPatch.context() as m:
            ...
            m.setattr("custom_components.meraki_dashboard.diagnostics.async_get_device_registry", 
    ...
    async def test_async_get_config_entry_diagnostics_coordinator_with_exception(self, hass: HomeAssistant, mock_config_entry):
...
class TestDiagnosticsUtilities:
    ...
    async def test_diagnostics_device_registry_integration(self, hass: HomeAssistant, mock_config_entry):
        ...
        with patch('custom_components.meraki_dashboard.diagnostics.async_get_device_registry') as mock_dr:
            ...
            mock_device_registry = MagicMock()
            mock_device_registry.devices = {"device_1": mock_device1, "device_2": mock_device2}
            mock_dr.return_value = mock_device_registry
