...
def mock_dashboard_api():
    ...
    api_mock.networks.getNetworkDevices.side_effect = lambda network_id: MOCK_DEVICES_DATA.get(network_id, [])
...
class TestMerakiDashboardConfigFlow:
    ...
    async def test_user_flow_success(self, hass: HomeAssistant, mock_config_flow, mock_dashboard_api):
        """Test successful user flow."""
        
        with patch("custom_components.meraki_dashboard.config_flow.meraki.DashboardAPI", return_value=mock_dashboard_api):
    ...
    async def test_user_flow_no_organizations(self, hass: HomeAssistant, mock_config_flow, mock_dashboard_api):
    ...
    async def test_organization_flow_success(self, hass: HomeAssistant, mock_config_flow, mock_dashboard_api):
    ...
    async def test_organization_flow_no_devices(self, hass: HomeAssistant, mock_config_flow, mock_dashboard_api):
    ...
    async def test_device_selection_flow(self, hass: HomeAssistant, mock_config_flow, mock_dashboard_api):
    ...
    async def test_reauth_flow_success(self, hass: HomeAssistant, mock_config_flow, mock_dashboard_api, mock_config_entry):
    ...
    async def test_reauth_flow_invalid_auth(self, hass: HomeAssistant, mock_config_flow, mock_config_entry):
    ...
    async def test_reauth_flow_forbidden(self, hass: HomeAssistant, mock_config_flow, mock_config_entry):
    ...
    async def test_options_flow_init(self, hass: HomeAssistant, mock_config_entry):
        ...
        from custom_components.meraki_dashboard.config_flow import MerakiDashboardOptionsFlow
    ...
    async def test_unique_id_handling(self, hass: HomeAssistant, mock_config_flow, mock_dashboard_api):
        ...
        mock_config_flow.async_set_unique_id.assert_called_once_with(MOCK_ORGANIZATION_DATA[0]["id"])
        assert result["type"] == FlowResultType.CREATE_ENTRY
...
class TestConfigFlowEdgeCases:
    ...
    async def test_user_flow_cannot_connect(self, hass: HomeAssistant, mock_config_flow):
    ...
    async def test_empty_organization_selection(self, hass: HomeAssistant, mock_config_flow, mock_dashboard_api):
