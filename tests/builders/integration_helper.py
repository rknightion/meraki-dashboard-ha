...
class IntegrationTestHelper:
    ...
    async def setup_meraki_integration(
        ...
        if devices:
            ...
            self._mock_api.organizations.getOrganizationDevicesAvailabilities.return_value = statuses
        ...
        with patch(
            "custom_components.meraki_dashboard.meraki_vendor.aio.AsyncDashboardAPI",
            return_value=async_api_mock,
        ):
