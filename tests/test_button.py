...
class TestMerakiOrgUpdateButton:
    ...
    def test_org_update_button_initialization(
        self, mock_org_hub, mock_config_entry, mock_coordinators
    ):
    ...
    async def test_org_update_button_press(
        self, mock_org_hub, mock_config_entry, mock_coordinators
    ):
    ...
    def test_org_update_button_availability(
        self, mock_org_hub, mock_config_entry, mock_coordinators
    ):
...
class TestMerakiNetworkUpdateButton:
    ...
    def test_network_update_button_initialization(
        self, mock_network_hub, mock_coordinator, mock_config_entry
    ):
    ...
    async def test_network_update_button_press(
        self, mock_network_hub, mock_coordinator, mock_config_entry
    ):
    ...
    def test_network_update_button_availability(
        self, mock_network_hub, mock_coordinator, mock_config_entry
    ):
...
class TestMerakiNetworkDiscoveryButton:
    ...
    def test_network_discovery_button_initialization(
        self, mock_network_hub, mock_config_entry
    ):
    ...
    async def test_network_discovery_button_press(
        self, mock_network_hub, mock_config_entry
    ):
    ...
    def test_network_discovery_button_availability(
        self, mock_network_hub, mock_config_entry
    ):
...
class TestButtonSetup:
    ...
    async def test_async_setup_entry_full_setup(
    ...
    async def test_async_setup_entry_no_org_hub(
        self, hass: HomeAssistant, mock_config_entry
    ):
