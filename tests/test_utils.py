...
def test_sanitize_attribute_value():
    ...
    assert sanitize_attribute_value("String with\x00null bytes") == "String withnull bytes"
    
    # Test string with control characters
    assert sanitize_attribute_value("String\x01with\x02control\x03chars") == "Stringwithcontrolchars"
