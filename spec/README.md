...
- **Do not hand-edit.** Refresh with `just refresh-meraki-spec`, then update the version above.
...
1. **Fix + re-vendor** — update the affected code, run `just refresh-meraki-spec`,
